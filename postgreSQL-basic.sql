...
(
    ...
    "creatorId" int references users(id) not null-- creator id refrences to table fan for the ids --setting up a foregin key
);
-- to add camelcase add double quotes
...
,posts,comments,favorites,friends RESTART IDENTITY;
...
values
    ('Kevon', 'Lebsack', 36, 'Daniela.Lindgren42@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Vada', 'Waelchi', 51, 'Zita.Bradtke78@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Virgil', 'Friesen', 63, 'Lizzie.Huels2@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Jerrell', 'Bode', 20, 'Reyna.Blanda@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Murray', 'Murray', 85, 'Joany.Kuhlman@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Carolyn', 'Pacocha', 14, 'Mohammad_Bergnaum@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Rowena', 'Rodriguez', 6, 'Vincenzo.Bartell@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Jordan', 'Schneider', 18, 'Eryn.Olson23@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Camylle', 'Buckridge', 34, 'Agnes.Bernhard51@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Dakota', 'Barton', 12, 'Dolores_Runte25@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Milton', 'Dickens', 84, 'Myrl.Morissette@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Agnes', 'Bailey', 97, 'Kylee15@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Barrett', 'Ritchie', 75, 'Maya_Treutel40@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Nels', 'Bode', 83, 'Quinton.Botsford@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Cleta', 'Streich', 1, 'Ronny5@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Marianna', 'Casper', 74, 'Chris_Trantow57@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Juliana', 'Kris', 30, 'Blaise_Greenfelder26@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Jerel', 'Lebsack', 49, 'Kayden_White@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Emie', 'Lesch', 97, 'Tito.Stracke70@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Alycia', 'Spinka', 85, 'Merlin67@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Luz', 'Gleichner', 17, 'Adela_Hintz@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Julianne', 'Cremin', 40, 'Cornelius.Trantow@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Vivian', 'Lind', 52, 'Leon_OKon71@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Marcel', 'Hauck', 76, 'Kenton_Bashirian@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Jordi', 'Kessler', 66, 'Consuelo41@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Brice', 'Ortiz', 32, 'Pauline.Wehner@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Alison', 'Yundt', 1, 'Josue15@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Maximo', 'Johnston', 36, 'Lenore_Bauch44@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Palma', 'Beier', 100, 'Jazmin.Grant@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Precious', 'Kozey', 79, 'Cara.Senger76@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Cordelia', 'Herman', 90, 'Bradley.Leuschke57@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Adah', 'Labadie', 22, 'Kasey69@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Watson', 'Paucek', 7, 'Favian41@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Javonte', 'Lang', 28, 'Della.Crona22@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Imogene', 'Gleichner', 76, 'Clinton.Bartoletti@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Chester', 'Stiedemann', 40, 'Pietro82@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Ryder', 'Torp', 55, 'Myrna36@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Alysa', 'Kozey', 29, 'Cathy.Labadie@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Benny', 'Gusikowski', 14, 'Alysha2@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Lexie', 'Satterfield', 93, 'Samir.Block79@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Trisha', 'Berge', 44, 'Catharine_Wyman@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Nakia', 'Zieme', 40, 'Alfred72@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Alison', 'Bernier', 55, 'Rene_Mueller@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Logan', 'Carter', 70, 'Damion.Leuschke@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Dovie', 'Langworth', 41, 'Joshua15@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Tomas', 'Haley', 39, 'Myrtis_Bartoletti@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Beatrice', 'Harber', 71, 'Gage98@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Earnestine', 'Fahey', 45, 'Bernita17@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Michaela', 'Grant', 24, 'Abbie_Hintz@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Jessie', 'Murphy', 9, 'Ibrahim58@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Monserrat', 'Stamm', 8, 'Kayleigh_Jaskolski@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Eddie', 'Homenick', 60, 'Lea.Schuster@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Osbaldo', 'Mueller', 23, 'Jayden_Brekke@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Garth', 'Murray', 50, 'Mikel85@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Corene', 'Kilback', 71, 'Shyanne.Kling44@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Alexane', 'Fritsch', 28, 'Karli.Zemlak39@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Luz', 'Pouros', 75, 'Giovanny.Parisian@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Lavinia', 'Breitenberg', 79, 'Don55@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Euna', 'Schuppe', 33, 'Odessa95@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Della', 'Shields', 38, 'Brielle_Rippin58@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Loyce', 'Powlowski', 68, 'Ernest56@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Cecelia', 'Morissette', 50, 'Glennie_Moore39@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Jody', 'Swift', 40, 'Caden56@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Malachi', 'Marks', 40, 'Terence.Crona88@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Claud', 'Hegmann', 29, 'Madelynn_Lueilwitz65@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Imelda', 'Ebert', 45, 'Tito.OKon@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Clint', 'Bartoletti', 83, 'Brain_Medhurst@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Ladarius', 'Koss', 32, 'Bert.Johns40@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Raven', 'Little', 34, 'Kaleb_Mills46@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Joanne', 'Cummerata', 35, 'Blair.Hudson@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Casandra', 'Bernhard', 3, 'Lydia94@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Gay', 'Boyer', 59, 'Steve21@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Teresa', 'Gleason', 2, 'Ulises.Spencer10@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Aurelio', 'Marks', 28, 'Iva.Fahey@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Gregorio', 'Schultz', 65, 'Terrance_Mohr@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Kraig', 'Wilkinson', 67, 'Trenton76@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Camila', 'Hand', 34, 'Chaya.Kuhic@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Marian', 'Fahey', 6, 'Terence_Lubowitz43@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Velda', 'Spencer', 74, 'Dariana98@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Jewell', 'Dietrich', 13, 'Britney_Renner67@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Carmella', 'Balistreri', 87, 'Antonia_Mante@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Shaina', 'Turcotte', 70, 'Elaina.Borer12@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Lowell', 'Lehner', 15, 'Zelda_Jacobson@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Jonathon', 'Bartoletti', 27, 'Westley_Davis@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Thalia', 'Murazik', 21, 'Jess_Mertz61@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Caitlyn', 'Conroy', 49, 'Carmine_Witting@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Lonny', 'Reichel', 24, 'Alden.Kerluke86@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Rodger', 'Hackett', 52, 'Wilfred_Osinski@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Emmitt', 'Lockman', 77, 'Cecile69@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Lola', 'Carroll', 92, 'Aida.Cummerata71@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Virginie', 'Maggio', 73, 'Kennedy58@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Sabryna', 'Greenfelder', 14, 'Carmelo.Kris@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Ervin', 'Sanford', 90, 'Kailyn_Kessler@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Dylan', 'Fisher', 41, 'Federico76@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Kay', 'Dicki', 44, 'Mya53@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Francis', 'Hilll', 67, 'Myrtle1@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Sister', 'Cronin', 18, 'Rashawn.Walker@yahoo.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Maurine', 'Shields', 78, 'Wade32@hotmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Johan', 'Quigley', 12, 'Devonte.Nader77@gmail.com');
insert into users
    (first_name,last_name,age,email)
values
    ('Dwight', 'Considine', 99, 'Aryanna43@gmail.com');
insert into posts
    (title,body,"creatorId")
values
    ('front-end transform relationships', 'Tempora ut soluta quis quam. Hic et et quas doloribus id repellat aut asperiores. Repellendus consectetur delectus officiis.
...
insert into posts
    (title,body,"creatorId")
values
    ('robust extend communities', 'Animi aperiam sed voluptas. Ut assumenda nihil et quaerat quod quisquam quaerat consectetur. Accusantium dolore id et facilis amet eum sit consequatur.
...
insert into posts
    (title,body,"creatorId")
values
    ('global extend supply-chains', 'Voluptas natus iste hic nihil ut. Ipsam delectus sed ut et blanditiis non et. Consequuntur cumque beatae quae sint voluptas nulla voluptate delectus quo. Sit libero neque est distinctio enim neque et consequuntur aut. Odio fuga voluptatem non minus.
...
insert into posts
    (title,body,"creatorId")
values
    ('efficient implement platforms', 'Quam aliquid odit inventore est ipsa. Nulla odio accusantium repellendus in inventore repellat laudantium ea atque. Quas aliquid et et totam. Dolor corporis sequi sequi dolorem hic. Voluptas veniam quia.
...
insert into posts
    (title,body,"creatorId")
values
    ('world-class reinvent web-readiness', 'Sit magnam vero qui. Eos quibusdam accusamus exercitationem qui et. Ratione rerum ut consequatur quibusdam id omnis quia consequatur. Quae et rem veniam beatae aut ipsum quas laudantium ex.
...
insert into posts
    (title,body,"creatorId")
values
    ('seamless repurpose e-commerce', 'Est et modi sed consequatur beatae aut ad. Excepturi voluptate amet odit occaecati minus enim. Maiores non consectetur ipsam.
...
insert into posts
    (title,body,"creatorId")
values
    ('frictionless incubate e-commerce', 'Deserunt facilis alias animi qui voluptatum. Amet dolor iusto fuga tempora. Et deleniti odit et. Est autem vel harum et quis laudantium. Quam quia at vel non eveniet dignissimos impedit. Dolor necessitatibus blanditiis maxime ea.
...
insert into posts
    (title,body,"creatorId")
values
    ('frictionless grow synergies', 'Esse et quos magni. Qui laborum fugiat itaque in ipsum. Ex officiis reprehenderit et quae ratione sit. Error illum nam beatae similique. Eligendi voluptatibus sint nesciunt aut iure.
...
insert into posts
    (title,body,"creatorId")
values
    ('leading-edge disintermediate e-commerce', 'Delectus et accusantium nostrum. Est et illo rerum voluptatum autem. Explicabo qui et pariatur ut. Explicabo non sit sint autem ut. Quaerat numquam rerum.
...
insert into posts
    (title,body,"creatorId")
values
    ('cutting-edge integrate methodologies', 'Adipisci quia veniam. Eos minus reiciendis. Cum aut nesciunt ipsa accusantium et minima aut quasi similique. Natus illo debitis saepe ut est. Sapiente nostrum sunt.
...
insert into posts
    (title,body,"creatorId")
values
    ('seamless visualize methodologies', 'Est voluptatem dolorem unde omnis ipsam sunt ipsum. Ab optio esse. Quos sed sint officiis dicta sit dolorem eum. Porro itaque delectus cumque error. Voluptatem earum error nisi aut qui sunt eos.
...
insert into posts
    (title,body,"creatorId")
values
    ('compelling evolve synergies', 'Nesciunt quia quis voluptatum vel molestiae velit. Iste optio mollitia. Est a sapiente ut facere veniam quia illum molestias. Impedit fugit delectus. Voluptatem harum fugiat quis est. Minima sint qui.
...
insert into posts
    (title,body,"creatorId")
values
    ('end-to-end utilize solutions', 'Omnis ut vitae nihil perspiciatis sequi consequatur. Facere deleniti voluptatem et. At aut inventore porro rerum. Tempora aut est repudiandae rerum est non nam possimus iste.
...
insert into posts
    (title,body,"creatorId")
values
    ('bleeding-edge matrix e-markets', 'Veniam et laboriosam. Quisquam odio hic iste et nihil ut quo quia quisquam. Ut et est et. Quae sequi molestias dolor modi consectetur repellendus.
...
insert into posts
    (title,body,"creatorId")
values
    ('intuitive orchestrate web services', 'Laboriosam vitae amet aut vitae quibusdam eos. Voluptatem temporibus totam aperiam consequatur. Sit non alias voluptate reprehenderit dolorum. Esse ut qui quisquam sed eum eum illum. At consectetur dolor nam cupiditate magnam et laboriosam.
...
insert into posts
    (title,body,"creatorId")
values
    ('B2C reinvent methodologies', 'Numquam aut sint pariatur quam quo dignissimos quia in. Tempore officiis suscipit ut ullam ipsa id. Minima reprehenderit culpa maxime cum quidem quia qui. Pariatur in molestias deleniti omnis provident id reprehenderit aspernatur. At exercitationem similique veniam id ut.
...
insert into posts
    (title,body,"creatorId")
values
    ('killer morph initiatives', 'Nostrum aliquam molestias iusto est ab nostrum et. Et ratione nobis sunt. Qui autem sit porro quo. Commodi in molestiae modi vel qui accusantium. Quibusdam ullam ut nulla quia autem. Eos ut temporibus nobis aspernatur et.
...
insert into posts
    (title,body,"creatorId")
values
    ('leading-edge whiteboard e-commerce', 'Ab ratione officiis quis sunt et. Enim id vel iste temporibus. Deleniti est veritatis quia magni consequatur. Sint inventore odio nesciunt explicabo. Est dignissimos ducimus deleniti sit.
...
insert into posts
    (title,body,"creatorId")
values
    ('collaborative repurpose initiatives', 'Asperiores sapiente quos eaque error id aut perferendis fuga dicta. Voluptatem magnam in suscipit distinctio esse officia a nemo. Vitae vero voluptate.
...
insert into posts
    (title,body,"creatorId")
values
    ('compelling deliver technologies', 'Praesentium quisquam rerum dolore corporis hic dolor nihil delectus. Possimus quam modi iusto sit deleniti praesentium. Enim sint deleniti vel cupiditate cum aspernatur. Aliquam occaecati ullam est expedita odio pariatur corrupti molestiae accusamus.
...
insert into posts
    (title,body,"creatorId")
values
    ('web-enabled recontextualize partnerships', 'Iste id est. Est sed expedita nam explicabo nam et enim. Nam labore exercitationem in repellat aut. Corporis ratione aspernatur sit voluptatibus molestiae sit aut.
...
insert into posts
    (title,body,"creatorId")
values
    ('leading-edge matrix bandwidth', 'Voluptas ut quam ut dolorum. Voluptatem nam consectetur facere dicta nostrum minus. Saepe facere laborum veritatis voluptate iste aut.
...
insert into posts
    (title,body,"creatorId")
values
    ('collaborative harness infomediaries', 'Illum fugiat dicta quae cupiditate eum voluptas cum eos optio. Voluptas aut voluptatem iste. Sunt non sint illum.
...
insert into posts
    (title,body,"creatorId")
values
    ('24/365 strategize markets', 'Dolor cumque adipisci sequi ipsum sunt. Quo voluptate qui deserunt placeat facere aut ullam. Temporibus enim facere voluptas cum doloremque eos ut. Odit quia ea laborum dicta voluptatem eum sed et aspernatur.
...
insert into posts
    (title,body,"creatorId")
values
    ('open-source embrace networks', 'Consectetur in recusandae natus aut unde ad provident harum repudiandae. Omnis nam aut autem quia voluptas repudiandae asperiores voluptate atque. Totam sapiente accusamus eum velit tempora porro velit.
...
insert into posts
    (title,body,"creatorId")
values
    ('back-end target action-items', 'Quo voluptatem libero adipisci et dolor laboriosam in. Magni ex facilis. Unde laudantium laborum aut sequi aut eos et commodi. Illo sed aut dolorem. Voluptates nihil consequatur.
...
insert into posts
    (title,body,"creatorId")
values
    ('B2C envisioneer users', 'Ullam et quae deserunt repellat earum. Delectus voluptates consequatur corrupti dolorem culpa. Ducimus velit impedit voluptatem.
...
insert into posts
    (title,body,"creatorId")
values
    ('integrated deploy e-business', 'Odio id minus magnam alias vel sequi accusantium placeat. Sit quibusdam at. Voluptatem recusandae non libero qui consequatur voluptatem officia quaerat voluptas.
...
insert into posts
    (title,body,"creatorId")
values
    ('visionary engineer users', 'Quia quia ut consectetur quo aut repudiandae. Ut non quam. Reiciendis iste possimus voluptate et labore velit.
...
insert into posts
    (title,body,"creatorId")
values
    ('24/365 transform users', 'Voluptatem reiciendis voluptatem atque veniam magnam. Illum hic asperiores. Non fuga vel ut consequatur sint. Aut at ut magni est.
...
insert into posts
    (title,body,"creatorId")
values
    ('magnetic seize communities', 'Ut aut atque aspernatur iste et provident. Quod dolor voluptas commodi debitis. Voluptatem fugiat ratione libero fuga quo voluptatem quidem. Provident quia delectus ut vitae dolorem. Dolore sunt accusamus repellat magni accusamus quisquam dolorem non.
...
insert into posts
    (title,body,"creatorId")
values
    ('interactive streamline metrics', 'Sequi quod cum vitae. Accusantium voluptatibus odio minima nemo non. Consequatur ab et omnis eos ad.
...
insert into posts
    (title,body,"creatorId")
values
    ('revolutionary transform systems', 'Consectetur ut dolor hic. Adipisci ratione omnis est culpa qui laborum sunt alias. Et ea temporibus aperiam dolores recusandae. Deserunt officia eum nihil accusamus aut ducimus eum velit ipsam. Nihil omnis consequatur quo. Non perferendis aut omnis.
...
insert into posts
    (title,body,"creatorId")
values
    ('scalable integrate deliverables', 'Voluptatibus fugit voluptas veniam minus perspiciatis sapiente ad. Deleniti quam officiis et ipsa et quam quo nulla rerum. Iusto qui ex.
...
insert into posts
    (title,body,"creatorId")
values
    ('sexy revolutionize partnerships', 'Sint magni odit nesciunt doloribus quae non dignissimos nisi. Libero tenetur laboriosam. Qui perferendis vero dolor consectetur consequuntur libero dolorum debitis. Qui eos nulla sit aut dolore ducimus neque voluptatibus.
...
insert into posts
    (title,body,"creatorId")
values
    ('visionary integrate e-commerce', 'Tempora omnis qui excepturi exercitationem quia temporibus libero qui voluptates. Aliquid sed et expedita error quibusdam id ea temporibus. Aut at tenetur. Et voluptas fugiat dolor dolorem non aut exercitationem provident. Doloremque sit voluptas ipsa minus odio nesciunt.
...
insert into posts
    (title,body,"creatorId")
values
    ('dynamic evolve niches', 'Excepturi quis molestiae sint eaque ratione. Quo culpa at cum officiis qui. Optio quo voluptas cupiditate voluptatibus et delectus nihil amet odit. Et aliquam voluptates mollitia quasi.
...
insert into posts
    (title,body,"creatorId")
values
    ('global synthesize web-readiness', 'Quia placeat libero officia quaerat facilis vero ea. Eligendi quis nisi autem autem sed enim quia hic adipisci. Fugiat nihil eveniet voluptatem voluptas officiis.
...
insert into posts
    (title,body,"creatorId")
values
    ('cross-platform matrix deliverables', 'Dolorem nisi quam ut unde. In animi aperiam aut quod voluptatibus atque. Adipisci repellendus delectus quia aut qui velit rem aut. Consequatur et explicabo aut quo unde ut voluptatem. Sint aut omnis repellendus a.
...
insert into posts
    (title,body,"creatorId")
values
    ('mission-critical reinvent e-business', 'Repudiandae voluptatem aut quam ad quo. Asperiores voluptatibus consequuntur blanditiis et possimus sequi enim. Magni voluptates similique. Consectetur deserunt sint quis dolor voluptas sed. Dolorem ex provident rerum.
...
insert into posts
    (title,body,"creatorId")
values
    ('transparent strategize infomediaries', 'Debitis aliquam asperiores maiores odit non. Similique numquam maxime soluta molestiae voluptatibus officia. Est totam rerum. Est aliquid quo quibusdam fuga quis quaerat veritatis minima quia. Dolore voluptatibus facilis modi optio harum ipsam. Nam voluptatem omnis et labore maxime illo minima.
...
insert into posts
    (title,body,"creatorId")
values
    ('cutting-edge disintermediate convergence', 'Quidem dignissimos occaecati dolor recusandae laborum et. Aut sint repellat vero libero qui quas nisi. Ad ipsam ut voluptates sunt quia placeat et fuga praesentium.
...
insert into posts
    (title,body,"creatorId")
values
    ('holistic implement systems', 'Saepe quis nihil aut est veniam. Culpa quibusdam aliquam praesentium quod velit non vero dolore deleniti. Modi nihil omnis eveniet. Illum deleniti a. Aut nemo dolores aut error quidem.
...
insert into posts
    (title,body,"creatorId")
values
    ('customized scale solutions', 'Vero culpa qui voluptate quod consequatur quo et. Dolorem autem iure distinctio dolores. Quasi ea et cumque repellat voluptatem expedita a. Asperiores totam ut laboriosam similique quo magnam. Temporibus ea qui ut nam et non.
...
insert into posts
    (title,body,"creatorId")
values
    ('seamless engage e-tailers', 'Eveniet quaerat placeat vitae consequatur numquam occaecati rerum eum quia. Ipsam corporis esse consequatur. Doloribus veniam sit officiis fugiat magnam distinctio voluptatem dignissimos suscipit. Ut deserunt molestiae.
...
insert into posts
    (title,body,"creatorId")
values
    ('plug-and-play reintermediate paradigms', 'Cumque esse itaque iure eos sit omnis et voluptatibus et. Delectus beatae eos. Maiores non occaecati eligendi quas error quia. Quasi velit nulla omnis velit omnis sed possimus incidunt. Quos repellendus accusantium et. Neque modi sint consectetur.
...
insert into posts
    (title,body,"creatorId")
values
    ('end-to-end cultivate experiences', 'Excepturi nihil tempore accusamus explicabo aut sapiente. Et ut eum nihil omnis cumque. Consequatur minus iure beatae qui debitis qui doloremque. Sit laborum qui totam quae. Aut vero tempore impedit ut blanditiis ut. Maiores aliquam aut delectus.
...
insert into posts
    (title,body,"creatorId")
values
    ('global e-enable partnerships', 'Cum molestiae autem. Dolorem sunt sapiente cupiditate dolorem mollitia. Sed soluta mollitia sunt sed perspiciatis enim. Quis sed impedit officia qui in est enim temporibus eligendi. Minima cumque et enim in.
...
insert into posts
    (title,body,"creatorId")
values
    ('dot-com matrix applications', 'Omnis accusamus exercitationem quibusdam mollitia. Et architecto optio rerum qui dolorum. Ducimus debitis dolores sit neque facilis quis. Et dolore enim fugiat voluptas labore nesciunt.
...
insert into posts
    (title,body,"creatorId")
values
    ('cross-platform visualize e-business', 'Qui deserunt optio aut vero quia. Et quisquam qui. Tempora quam voluptatem.
...
insert into posts
    (title,body,"creatorId")
values
    ('proactive recontextualize e-commerce', 'Autem praesentium odit. Sint ducimus maiores. Eveniet voluptatem aliquid vitae ratione quia reprehenderit.
...
insert into posts
    (title,body,"creatorId")
values
    ('24/365 whiteboard convergence', 'Architecto voluptas dolor perferendis voluptas hic quia. In omnis vel accusamus neque a. Fugiat exercitationem consequatur sint iste dolore voluptate. Vitae illum voluptas. Consequatur quidem necessitatibus pariatur.
...
insert into posts
    (title,body,"creatorId")
values
    ('sticky disintermediate schemas', 'Doloremque quibusdam amet. Delectus odio et nemo aspernatur fugit quasi laboriosam. Rerum quo deserunt dolor optio suscipit. Culpa sed tempora nemo incidunt aut numquam nostrum maxime natus. Repellat quae facere est odit impedit ducimus.
...
insert into posts
    (title,body,"creatorId")
values
    ('wireless redefine bandwidth', 'Est neque tenetur esse non nihil. Ex blanditiis voluptate veniam rerum ipsum. In ut provident similique voluptate inventore. Voluptas rerum omnis et ratione iusto numquam doloremque. Laborum totam maiores iure.
...
insert into posts
    (title,body,"creatorId")
values
    ('virtual cultivate functionalities', 'Quod rerum aut ipsam reprehenderit. Explicabo omnis asperiores vel aspernatur voluptatem reprehenderit ut et. Velit aut dicta porro molestias quibusdam. Maiores aut et excepturi earum iure omnis et.
...
insert into posts
    (title,body,"creatorId")
values
    ('e-business exploit paradigms', 'Quis voluptatem consequatur aut omnis aliquid. Consequatur rerum omnis non autem voluptas. Laboriosam occaecati sunt. Et beatae sint nemo laudantium aspernatur eum natus natus dolores.
...
insert into posts
    (title,body,"creatorId")
values
    ('B2B synthesize methodologies', 'Enim et aspernatur ipsum sit facere quia distinctio voluptas distinctio. Veritatis est voluptatem nobis suscipit. Vel qui vitae voluptatem qui velit ullam voluptatem.
...
insert into posts
    (title,body,"creatorId")
values
    ('plug-and-play recontextualize e-commerce', 'Laudantium magnam odio et. Aut eveniet et ducimus dicta architecto nesciunt. Commodi quo officiis sit ullam. Rem enim qui. Rerum aut accusantium nostrum perspiciatis cum.
...
insert into posts
    (title,body,"creatorId")
values
    ('back-end evolve initiatives', 'Pariatur vitae est eos blanditiis suscipit deleniti. Rerum deleniti rerum quam distinctio quia repellendus officia iure vel. Ipsam libero ut autem odit praesentium et quis quia rerum.
...
insert into posts
    (title,body,"creatorId")
values
    ('visionary extend deliverables', 'Optio voluptatem impedit eos quia quod. Reprehenderit quia voluptas consequatur magni. Ea nobis omnis. Sequi temporibus quidem illum ullam reiciendis rem provident. Ut ratione laudantium et perspiciatis at tenetur.
...
insert into posts
    (title,body,"creatorId")
values
    ('leading-edge exploit mindshare', 'Beatae est unde eligendi quod eius. Esse est quae et possimus non. Et hic nesciunt necessitatibus. Consequatur nihil nulla a ut ut fugit aut et.
...
insert into posts
    (title,body,"creatorId")
values
    ('ubiquitous monetize action-items', 'Perferendis rem repellat unde voluptas sed quia dolor voluptatem. Sit quasi nam. Aperiam qui autem ducimus aliquam laborum consequatur consequatur perspiciatis. Explicabo dignissimos ex voluptatibus commodi est. Ut placeat sed similique ullam sed facere.
...
insert into posts
    (title,body,"creatorId")
values
    ('magnetic monetize channels', 'Cum laudantium est est dolor cum esse illum. Repellendus exercitationem tenetur. Sed nemo omnis qui debitis quaerat commodi.
...
insert into posts
    (title,body,"creatorId")
values
    ('transparent engage bandwidth', 'Vero numquam consectetur libero. Qui numquam ipsa ut recusandae perferendis. Nam culpa et eius et fugit. Rem illum qui similique.
...
insert into posts
    (title,body,"creatorId")
values
    ('back-end morph e-services', 'Earum rem labore incidunt repellendus. Fuga tempora qui voluptas ab vel. Sed eaque iure molestias. Animi excepturi corrupti et accusamus repellendus et est. Unde id ipsam consequatur est ducimus mollitia provident. Doloremque ea earum nostrum perferendis dicta labore doloremque temporibus possimus.
...
insert into posts
    (title,body,"creatorId")
values
    ('vertical reinvent platforms', 'Et et eligendi expedita magni dolorum quaerat reiciendis cumque qui. Labore labore necessitatibus velit nemo laborum adipisci voluptatibus ut. Voluptates eaque maxime. Ducimus magni aspernatur rerum accusamus inventore esse quos aspernatur pariatur. Accusantium quia ut molestiae nisi ab. Hic beatae dignissimos consequuntur sed accusantium.
...
insert into posts
    (title,body,"creatorId")
values
    ('transparent strategize relationships', 'Amet dolore eius. Suscipit facere doloribus error. Illo dicta quia soluta. Nostrum adipisci et nostrum. Beatae ut veniam.
...
insert into posts
    (title,body,"creatorId")
values
    ('revolutionary leverage deliverables', 'Est recusandae rerum. Nam veritatis veritatis aut sunt aspernatur. Pariatur sint praesentium voluptate dolores in. Debitis perspiciatis delectus.
...
insert into posts
    (title,body,"creatorId")
values
    ('wireless expedite networks', 'Et molestiae qui quis cum dolore sunt autem. Et soluta nihil in id consequatur. Blanditiis molestiae aut dolor eius assumenda quia qui. Sunt sunt quasi rem quia suscipit.
...
insert into posts
    (title,body,"creatorId")
values
    ('integrated orchestrate users', 'Ipsum eum labore consectetur vitae enim autem autem officia. Dolor asperiores temporibus ut dignissimos. Odio qui et.
...
insert into posts
    (title,body,"creatorId")
values
    ('proactive transform content', 'Dolores ab occaecati fugiat ad occaecati sed et earum. At eius aut. Minus veniam earum quis est quidem ut vel. Corporis et in quam illum a molestiae modi.
...
insert into posts
    (title,body,"creatorId")
values
    ('24/365 mesh markets', 'Eveniet qui minima maxime quasi sunt. Ut non amet et eaque laboriosam tenetur qui. Quibusdam quia accusamus enim molestiae adipisci omnis. Illum repellendus tempore. Et voluptatibus quibusdam esse ut architecto iusto.
...
insert into posts
    (title,body,"creatorId")
values
    ('front-end implement partnerships', 'Eos nisi amet neque assumenda voluptatum voluptatum tempore debitis. Esse id autem illo qui. Quia exercitationem eaque corrupti quasi qui aut cumque. Repellat est molestiae.
...
insert into posts
    (title,body,"creatorId")
values
    ('open-source cultivate interfaces', 'Optio mollitia et inventore rem. Quod qui porro quasi ab. Ad sint nisi laboriosam iusto culpa voluptas ipsum odio et. Vel odit asperiores qui beatae et enim eius rerum ad.
...
insert into posts
    (title,body,"creatorId")
values
    ('rich syndicate channels', 'Deleniti labore eveniet mollitia ut omnis culpa ad eum adipisci. A et fugiat adipisci. Et adipisci qui non quis. Neque id ut autem iste odit velit tempora. Officia aut id voluptates aut alias et inventore iure.
...
insert into posts
    (title,body,"creatorId")
values
    ('cross-platform leverage experiences', 'Expedita unde eum voluptas dolorem vel aut at. Dolor vel porro est non omnis aut. Enim aut vel qui consectetur vel placeat atque nulla doloribus. Qui saepe natus sed aut voluptatem et quas. Quia numquam ducimus. Aliquid possimus voluptatem rerum.
...
insert into posts
    (title,body,"creatorId")
values
    ('out-of-the-box reintermediate vortals', 'Exercitationem aspernatur quia animi sit atque aliquid et. Est nemo temporibus quas voluptatem. Enim quas consequuntur autem amet quidem rerum dolores. Culpa blanditiis alias fugit ipsa cupiditate molestias illo.
...
insert into posts
    (title,body,"creatorId")
values
    ('synergistic redefine architectures', 'Rerum quaerat est tenetur id sapiente amet ea sunt. Ullam occaecati placeat dolores ipsum suscipit. Quia assumenda quibusdam incidunt qui sit autem. Tempora vel quos id dolore.
...
insert into posts
    (title,body,"creatorId")
values
    ('viral visualize content', 'Sed et qui eaque aliquam. Dolor vel blanditiis voluptatem vel reiciendis et quia. Tempora nesciunt voluptate placeat nisi assumenda est. Consequatur officiis eveniet expedita rerum. Minus enim voluptatem commodi. Vel aliquam quia laboriosam asperiores nihil et.
...
insert into posts
    (title,body,"creatorId")
values
    ('magnetic embrace experiences', 'Ut dolores inventore minus iste. Ut et quia. Doloremque consequuntur quod nihil cum earum. Consequatur est commodi repellat suscipit. Amet voluptas nesciunt placeat nihil voluptatibus architecto doloremque.
...
insert into posts
    (title,body,"creatorId")
values
    ('cross-platform revolutionize partnerships', 'Quia qui excepturi. Aut quo quidem ut corporis aut itaque eaque. Illo odit at dignissimos commodi reprehenderit nesciunt ut aliquam tempore.
...
insert into posts
    (title,body,"creatorId")
values
    ('back-end target e-business', 'Dolorem et enim sit et rerum. Ipsum tempora facilis consequatur id doloribus necessitatibus vel sint. Culpa pariatur repellat eos. Quae non consequatur non pariatur dignissimos sint non architecto suscipit.
...
insert into posts
    (title,body,"creatorId")
values
    ('best-of-breed reinvent solutions', 'Voluptas odit dolores velit deleniti ut. Nihil porro temporibus possimus vero aut ut quis. Qui saepe non nobis non sed. Ut natus nihil animi dolor temporibus quibusdam. Sit laudantium inventore optio et id consequatur.
...
insert into posts
    (title,body,"creatorId")
values
    ('virtual aggregate interfaces', 'Beatae et mollitia doloribus. Beatae et magni. Molestiae qui cumque minima atque sapiente. Soluta eum nihil voluptatem vero non. Officiis enim eos ipsam ut iusto ut.
...
insert into posts
    (title,body,"creatorId")
values
    ('e-business monetize relationships', 'Quo dolorem eos et quam dicta velit qui. Sed ut hic. Doloremque laudantium quidem.
...
insert into posts
    (title,body,"creatorId")
values
    ('B2B reinvent solutions', 'Voluptatem voluptas tenetur dolorum unde rerum nihil sint aliquid. Id dolor eum quam modi quia et. Minus eligendi neque perspiciatis quaerat in. Deleniti ratione fuga earum sed aperiam. Ut impedit et qui neque facilis possimus et blanditiis.
...
insert into posts
    (title,body,"creatorId")
values
    ('viral disintermediate action-items', 'Quaerat voluptates voluptatem officia. Ducimus ipsam aliquam porro vel natus doloremque. Illo enim facilis. Aut illo architecto quae magnam commodi eum velit nostrum.
...
insert into posts
    (title,body,"creatorId")
values
    ('e-business matrix web services', 'Aperiam eos magni fugiat id. Doloremque et exercitationem. Dolorum rem hic rerum veniam ipsa non fugit et. Eum impedit laborum. Beatae earum sequi architecto totam sit quia cum nulla. Ullam culpa beatae cupiditate enim.
...
insert into posts
    (title,body,"creatorId")
values
    ('next-generation morph e-tailers', 'Omnis facilis dolorum dolor quam voluptas autem iure enim et. Et quo praesentium alias. Rerum iste nam dicta in ut illum et voluptate. Temporibus cupiditate esse et.
...
insert into posts
    (title,body,"creatorId")
values
    ('enterprise matrix vortals', 'Nesciunt ut quo. Incidunt qui omnis soluta repudiandae dicta et. Ut reiciendis qui. Eius quo excepturi sequi ea similique. Excepturi doloribus necessitatibus voluptatem.
...
insert into posts
    (title,body,"creatorId")
values
    ('impactful target solutions', 'Nam laborum molestiae ut aut. Commodi dolorem id in harum unde doloremque. Quo qui possimus officiis nisi provident. Deserunt et distinctio est consequatur aspernatur.
...
insert into posts
    (title,body,"creatorId")
values
    ('interactive expedite infrastructures', 'Et quia non. At et provident ut sint et eaque. Nisi non quam ratione saepe.
...
insert into posts
    (title,body,"creatorId")
values
    ('interactive target channels', 'Doloribus soluta sint. Numquam voluptatem accusamus mollitia. Mollitia nostrum mollitia. Rem fuga omnis iste animi ad modi et dolores. Et ad nisi quis qui itaque molestiae tempora voluptas.
...
values
    ('Odit cupiditate aliquid aut quaerat tempora ut.', 68, 29);
insert into comments
    (message,post_id,creator_id)
values
    ('Hic et et quas doloribus id repellat aut asperiores.', 20, 79);
insert into comments
    (message,post_id,creator_id)
values
    ('Officiis magnam dolorum qui nihil et qui rerum consequatur accusantium.', 4, 50);
insert into comments
    (message,post_id,creator_id)
values
    ('Adipisci blanditiis quis.', 83, 8);
insert into comments
    (message,post_id,creator_id)
values
    ('Repellendus id natus.', 64, 85);
insert into comments
    (message,post_id,creator_id)
values
    ('Quas corrupti mollitia dolorem explicabo.', 17, 10);
insert into comments
    (message,post_id,creator_id)
values
    ('Commodi iusto est et.', 53, 51);
insert into comments
    (message,post_id,creator_id)
values
    ('Vero maxime inventore delectus voluptatum sapiente doloremque distinctio alias.', 26, 52);
insert into comments
    (message,post_id,creator_id)
values
    ('Ipsum maiores maiores sit distinctio nobis velit ut et.', 16, 37);
insert into comments
    (message,post_id,creator_id)
values
    ('Quo illo sit quasi temporibus.', 24, 52);
insert into comments
    (message,post_id,creator_id)
values
    ('Animi aperiam sed voluptas.', 78, 27);
insert into comments
    (message,post_id,creator_id)
values
    ('Et quaerat quod quisquam quaerat consectetur fugiat accusantium.', 25, 74);
insert into comments
    (message,post_id,creator_id)
values
    ('Amet eum sit consequatur accusantium sapiente temporibus a.', 59, 55);
insert into comments
    (message,post_id,creator_id)
values
    ('Et aut fuga quod.', 75, 2);
insert into comments
    (message,post_id,creator_id)
values
    ('Eveniet temporibus dolorem in cumque placeat et vitae.', 83, 30);
insert into comments
    (message,post_id,creator_id)
values
    ('Explicabo velit quae sapiente adipisci omnis et consequatur accusantium.', 78, 85);
insert into comments
    (message,post_id,creator_id)
values
    ('Ab dolorem cum aspernatur quia.', 74, 7);
insert into comments
    (message,post_id,creator_id)
values
    ('Saepe debitis sint sunt.', 18, 53);
insert into comments
    (message,post_id,creator_id)
values
    ('Exercitationem non voluptatem sed nostrum libero.', 69, 27);
insert into comments
    (message,post_id,creator_id)
values
    ('Pariatur occaecati corrupti voluptas natus iste.', 95, 43);
insert into comments
    (message,post_id,creator_id)
values
    ('Ipsam delectus sed ut et blanditiis non et.', 98, 13);
insert into comments
    (message,post_id,creator_id)
values
    ('Quae sint voluptas.', 85, 41);
insert into comments
    (message,post_id,creator_id)
values
    ('Et sit libero neque est distinctio enim neque.', 25, 13);
insert into comments
    (message,post_id,creator_id)
values
    ('Odio fuga voluptatem non minus.', 16, 40);
insert into comments
    (message,post_id,creator_id)
values
    ('Non saepe occaecati illo corrupti.', 97, 17);
insert into comments
    (message,post_id,creator_id)
values
    ('Eius rerum est expedita quo voluptas porro.', 81, 67);
insert into comments
    (message,post_id,creator_id)
values
    ('Facere aliquid nulla similique aperiam.', 49, 77);
insert into comments
    (message,post_id,creator_id)
values
    ('Cum odio est qui repellendus quia aliquid.', 3, 42);
insert into comments
    (message,post_id,creator_id)
values
    ('Perferendis libero ipsam qui.', 89, 80);
insert into comments
    (message,post_id,creator_id)
values
    ('Adipisci asperiores eaque eaque doloribus consequatur dolorum.', 85, 53);
insert into comments
    (message,post_id,creator_id)
values
    ('Voluptatem ut cumque.', 47, 43);
insert into comments
    (message,post_id,creator_id)
values
    ('Inventore est ipsa.', 90, 85);
insert into comments
    (message,post_id,creator_id)
values
    ('Repellendus in inventore.', 100, 47);
insert into comments
    (message,post_id,creator_id)
values
    ('Quis quas aliquid et et totam.', 48, 79);
insert into comments
    (message,post_id,creator_id)
values
    ('Sequi dolorem hic dicta.', 77, 29);
insert into comments
    (message,post_id,creator_id)
values
    ('Ex eveniet non vitae.', 13, 54);
insert into comments
    (message,post_id,creator_id)
values
    ('Sunt ut consequatur.', 11, 51);
insert into comments
    (message,post_id,creator_id)
values
    ('Facilis unde molestiae quaerat optio quia aut quia nobis.', 7, 63);
insert into comments
    (message,post_id,creator_id)
values
    ('Iure sunt quam eum deleniti.', 66, 51);
insert into comments
    (message,post_id,creator_id)
values
    ('Perspiciatis dolore nesciunt ut.', 19, 23);
insert into comments
    (message,post_id,creator_id)
values
    ('Tempora enim possimus adipisci et velit.', 4, 61);
insert into comments
    (message,post_id,creator_id)
values
    ('Sit magnam vero qui.', 49, 87);
insert into comments
    (message,post_id,creator_id)
values
    ('Exercitationem qui et vero ratione rerum ut consequatur quibusdam.', 74, 56);
insert into comments
    (message,post_id,creator_id)
values
    ('Voluptates quae et rem veniam.', 8, 2);
insert into comments
    (message,post_id,creator_id)
values
    ('Laudantium ex quae odit sit ullam eos.', 77, 81);
insert into comments
    (message,post_id,creator_id)
values
    ('Ipsam doloremque dolor et.', 47, 78);
insert into comments
    (message,post_id,creator_id)
values
    ('Ea et beatae repudiandae.', 17, 80);
insert into comments
    (message,post_id,creator_id)
values
    ('Sed veritatis odio impedit nesciunt dolorem maiores ut iste repellat.', 75, 26);
insert into comments
    (message,post_id,creator_id)
values
    ('Ut ad aperiam et architecto est.', 51, 4);
insert into comments
    (message,post_id,creator_id)
values
    ('Ut enim blanditiis.', 83, 63);
insert into comments
    (message,post_id,creator_id)
values
    ('Quo et cum sed optio est et.', 23, 54);
insert into comments
    (message,post_id,creator_id)
values
    ('Aut ad quas.', 52, 41);
insert into comments
    (message,post_id,creator_id)
values
    ('Occaecati minus enim.', 16, 99);
insert into comments
    (message,post_id,creator_id)
values
    ('Ipsam vel reiciendis delectus.', 74, 4);
insert into comments
    (message,post_id,creator_id)
values
    ('Quibusdam aut totam sit impedit et aut quis.', 29, 32);
insert into comments
    (message,post_id,creator_id)
values
    ('Veniam quos tempora ducimus delectus.', 15, 12);
insert into comments
    (message,post_id,creator_id)
values
    ('Ipsum sit quo necessitatibus quis.', 24, 53);
insert into comments
    (message,post_id,creator_id)
values
    ('Autem et rerum.', 54, 50);
insert into comments
    (message,post_id,creator_id)
values
    ('Vitae quidem itaque odio hic nesciunt officia ut.', 73, 94);
insert into comments
    (message,post_id,creator_id)
values
    ('Voluptatem laborum iste.', 41, 34);
insert into comments
    (message,post_id,creator_id)
values
    ('Veniam voluptas eum deserunt facilis alias animi.', 83, 48);
insert into comments
    (message,post_id,creator_id)
values
    ('Dolor iusto fuga tempora.', 25, 62);
insert into comments
    (message,post_id,creator_id)
values
    ('Et occaecati est.', 38, 39);
insert into comments
    (message,post_id,creator_id)
values
    ('Quis laudantium porro quam quia at.', 39, 21);
insert into comments
    (message,post_id,creator_id)
values
    ('Impedit ea dolor necessitatibus blanditiis maxime.', 37, 45);
insert into comments
    (message,post_id,creator_id)
values
    ('Ab aliquam ad.', 71, 17);
insert into comments
    (message,post_id,creator_id)
values
    ('Et quia qui quo est eveniet eligendi maxime sequi sed.', 40, 69);
insert into comments
    (message,post_id,creator_id)
values
    ('Qui animi et.', 11, 79);
insert into comments
    (message,post_id,creator_id)
values
    ('Enim qui modi omnis impedit.', 34, 29);
insert into comments
    (message,post_id,creator_id)
values
    ('Sequi aut assumenda neque nemo.', 96, 66);
insert into comments
    (message,post_id,creator_id)
values
    ('Eum quis sed ut eos.', 74, 89);
insert into comments
    (message,post_id,creator_id)
values
    ('Eos rerum sed optio tempore dicta sit.', 33, 48);
insert into comments
    (message,post_id,creator_id)
values
    ('Facilis ipsum esse et quos magni laudantium.', 40, 62);
insert into comments
    (message,post_id,creator_id)
values
    ('In ipsum molestias ex officiis reprehenderit et quae ratione sit.', 27, 57);
insert into comments
    (message,post_id,creator_id)
values
    ('Beatae similique in eligendi voluptatibus sint nesciunt aut.', 39, 89);
insert into comments
    (message,post_id,creator_id)
values
    ('Sequi ut quis possimus.', 19, 66);
insert into comments
    (message,post_id,creator_id)
values
    ('Dolorum et aut dignissimos facere non ducimus itaque voluptas.', 93, 66);
insert into comments
    (message,post_id,creator_id)
values
    ('Odit velit quo.', 4, 83);
insert into comments
    (message,post_id,creator_id)
values
    ('Consequuntur deserunt voluptate repudiandae autem officia harum totam enim minus.', 13, 12);
insert into comments
    (message,post_id,creator_id)
values
    ('Perferendis voluptate et illum non perspiciatis sit ex doloribus.', 54, 61);
insert into comments
    (message,post_id,creator_id)
values
    ('Totam nobis quas dignissimos dolorem ut autem qui.', 12, 40);
insert into comments
    (message,post_id,creator_id)
values
    ('Ut neque delectus.', 7, 3);
insert into comments
    (message,post_id,creator_id)
values
    ('Est et illo rerum voluptatum autem.', 37, 10);
insert into comments
    (message,post_id,creator_id)
values
    ('Pariatur ut autem.', 10, 22);
insert into comments
    (message,post_id,creator_id)
values
    ('Autem ut sit quaerat numquam rerum voluptas libero ut odit.', 23, 10);
insert into comments
    (message,post_id,creator_id)
values
    ('Enim consequatur suscipit qui tempora deserunt iusto.', 46, 41);
insert into comments
    (message,post_id,creator_id)
values
    ('Facilis et accusamus sint est facilis deserunt ipsam culpa.', 34, 96);
insert into comments
    (message,post_id,creator_id)
values
    ('Aspernatur itaque doloribus.', 18, 77);
insert into comments
    (message,post_id,creator_id)
values
    ('Sequi quia laboriosam eveniet.', 83, 18);
insert into comments
    (message,post_id,creator_id)
values
    ('Blanditiis repellendus cum sapiente tempora illo eos unde.', 92, 56);
insert into comments
    (message,post_id,creator_id)
values
    ('Et omnis tenetur aspernatur voluptas quod voluptatem ipsam.', 24, 86);
insert into comments
    (message,post_id,creator_id)
values
    ('Consequatur et doloremque adipisci quia veniam voluptatem eos minus reiciendis.', 99, 68);
insert into comments
    (message,post_id,creator_id)
values
    ('Ipsa accusantium et minima.', 98, 8);
insert into comments
    (message,post_id,creator_id)
values
    ('Natus illo debitis saepe ut est.', 2, 97);
insert into comments
    (message,post_id,creator_id)
values
    ('Cum sit consequuntur.', 96, 64);
insert into comments
    (message,post_id,creator_id)
values
    ('Voluptatem corporis nulla asperiores ea ut quo.', 91, 52);
insert into comments
    (message,post_id,creator_id)
values
    ('Voluptatem blanditiis earum.', 98, 18);
insert into comments
    (message,post_id,creator_id)
values
    ('Enim et fugit et sed reprehenderit fuga.', 50, 60);
insert into comments
    (message,post_id,creator_id)
values
    ('Et tempora ratione neque qui deleniti unde sequi nesciunt aut.', 60, 94);
insert into comments
    (message,post_id,creator_id)
values
    ('Sit quisquam ut illo ullam accusantium iusto est.', 6, 87);
...
select p.title, p.body, u.first_name, p."creatorId"
from posts p
    inner join users u on p."creatorId" = u.id;
-- you're just adding users u on to posts.creatorId which is equal to users id


select c.message , u.id users_id
from comments c
    inner join users u on c.creator_id = u.id;


--alter table
-- alters the table and adds random dates with-in interval of 100days 
alter table posts 
...
select p.created_at, p.title, p.body post_body, u.first_name
from posts p
    inner join users u on p."creatorId" = u.id
-- order by created_at -- orders by chronological order , its assending by default 
order by created_at desc;


-- doing substring to fetch less of it 


select p.created_at,
    p.title,
    substring( p.body,1, 23) post_body, -- 1 is the starting position and 23 is the number of char
    u.first_name
from posts p
    inner join users u on p."creatorId" = u.id
order by created_at desc;
...
-- pagination using limits && offset
...
p.title,
substring
( p.body,1, 23) post_body, -- 1 is the starting position and 23 is the number of char
u.first_name from posts p 
inner join users u on p."creatorId" = u.id 
order by created_at desc
offset 20  -- 0 for first page , 20 for second page and 40 for third page // in limit of 20
limit 20;




-- pagination using cursor base


select p.created_at,
    p.title,
    substring( p.body,1, 23) post_body,
    u.first_name
from posts p
    inner join users u on p."creatorId" = u.id
where created_at > '2020-12-07'
order by created_at desc
limit 30;


-- ids will go as var
-- posts (fetching a single post)

select p.title, u.first_name, c.message, u2.first_name comment_creator from posts p
inner join users u on p
."creatorId" = u.id 
...
-- count the number of rows you get back


select count(*)
from users;

-- you cant get anything else of the number of count , like trying to get the number of count and comments at the same time
...
from posts p
    ...
    on f.post_id = p.id and f.user_id = 79
where p.id = 7;
...
-- group by
-- grouping by user_id1 so we can select it and we are counting the user_id2 (for the numbers)
select user_id1, count(user_id2)
from friends f
group by user_id1



-- to aggregate the values in row
select user_id1,
    array_agg(user_id2),
    count(user_id2)
from friends f
...
--to get who has most friends
--(in respect to the user_id1)
select
    max( u.first_name), -- max is going to give one name else of all the repeated same name using array_arr 
    user_id1,
    array_agg(user_id2),
    count(user_id2)
from friends f
...
-- posts that have likes from a user
select array_agg(f.post_id) post_id , user_id
from favorites f
...
-- posts that have the highest number of likes 
select post_id, count(*) likes
from favorites f
    inner join posts p on f.post_id
group by post_id
order by count(*) desc;


-- left join 
-- left join is great when they dont have something
-- who has no friends
